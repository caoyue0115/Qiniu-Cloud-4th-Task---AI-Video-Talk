...
### 👉 在线 Demo：**https://distance-regulated-divisions-austin.trycloudflare.com**
...
> ⚠️ **说明**：在线 Demo 部署在云服务器 + cloudflared 隧道上，服务器持续运行期间可访问；隧道进程若重启地址会变。**若链接失效，请观看上方演示视频，或按下方「本地运行」自行启动。**

📱 **手机访问更佳**：用手机浏览器打开同一地址，允许摄像头/麦克风，体验完整通话（评委如不便用手机，看演示视频即可了解完整效果）。
